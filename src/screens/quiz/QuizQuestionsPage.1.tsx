...
import { ExitButton, FinishButton, LoginButton } from '../../components/common/ButttonComponent/ButtonStyles';
import { styles } from './QuizQuestionsPage';
            ...
            <View style={styles.header}>
                <View style={styles.heading}>
                    ...
                    <View style={{ position: "absolute", right: 10 }}>
                        ...
                        <Button label={'Finish Test'} disabled={false} className={FinishButton} onPress={() => setModalVisible(true)} />
                    </View>
                </View>
            </View>
