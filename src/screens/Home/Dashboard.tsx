...
import { ArrowIcon, ArrowLeft, Send, Sprit, Star } from '../../components/common/SvgComponent/SvgComponent'
                ...
                <View style={DashboardStyle.options}>
                    ...
                    <View style={DashboardStyle.optionsCard}>
                        <View style={DashboardStyle.option}>
                            ...
                            <IconButton className={PrimaryIconDefaultButton} onPress={function (): void {
